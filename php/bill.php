...
<?php
echo"<hr style='border: 1px solid black;'>";
echo"Total Amount Paid: ". $_SESSION['subtotal'];
echo"<br>";
echo"<hr style='border: 1px solid black;'>";
?></div>
</div>
...
Delivery Address:
<hr style="border: 1px solid black;">
<br>Estimated Delivery Time: 2-3 days<br>
<?php
...
<input type="submit" name="home" value="Home" style="font-family:Verdana, sans-serif;font-weight:bold;font-size:15 pt;color:black;background-color:white;border:2px solid #000000;padding:1px;height:50px;width:200px;">
</form>
</center>
