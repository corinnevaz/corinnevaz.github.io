...
<div id="sidebar">
  ...
  <h2>CUSTOMER PROFILE</h2>
    ...
    <div class="infront">
    	<h3><a href="customer_profile.php">PROFILE </a></h3>
		        <h3><a href="customer_order.php">ORDER</a></h3>

		<h3><a href="customer_profile_app_confir.php">APPOINTMENT </a></h3>
...
$sql = "SELECT * FROM customer WHERE customer_id =".$_SESSION['cust_id'];
...
if ($result->num_rows > 0) {
  ...
  echo '<table>'; 
    echo '<tr> ';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px"><b> Customer-id:</b></td>';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px">'. $row['customer_id'] .'</td> ';
    echo '</tr>';
	echo '<tr> ';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px"><b> Customer Name:</b></td>';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px">'. $row['customer_name'] .'</td> ';
    echo '</tr>';
		echo '<tr> ';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;"><b>Age:</b></td>';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;">'. $row['customer_age'] .'</td> ';
    echo '</tr>';
	echo '<tr> ';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;"><b> Phone:</b></td>';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;">'. $row['customer_phone'] .'</td> ';
    echo '</tr>';
	echo '<tr> ';
	echo '<tr> ';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;"><b> Email-ID:</b></td>';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;">'. $row['customer_email'] .'</td> ';
    echo '</tr>';
	echo '<tr> ';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;"><b> Address:</b></td>';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;">'. $row['address'] .'</td> ';
    echo '</tr>';
