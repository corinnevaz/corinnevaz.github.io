...
<link href="..\css\doctor_profile_appconfir.css" rel="stylesheet" type="text/css">
...
<div id="sidebar">
  ...
  <h2>DOCTOR PROFILE</h2>
    ...
    <div class="infront">
    	<h3><a href="doctor_profile.php">Profile </a></h3>
		<h3><a href="doctor_profile_appconfir.php">APPOINTMENT CONFIRMATION</a></h3>

        <h3><a href="doctor_profile_booking.php">APPOINTMENT BOOKING HISTORY</a></h3>
		 </form>
...
$sql = "SELECT * FROM doc_per WHERE doctor_id =".$_SESSION['doc_id'];
...
if ($result->num_rows > 0) {
  ...
  echo '<table>'; 
    echo '<tr> ';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px"><b> Doctor-id:</b></td>';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px">'. $row['doctor_id'] .'</td> ';
    echo '</tr>';
	echo '<tr> ';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px"><b> Doctor Name:</b></td>';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px">'. $row['doctor_name'] .'</td> ';
    echo '</tr>';
	echo '<tr> ';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;"><b> Doctor Gender:</b></td>';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;">'. $row['doctor_gender'] .'</td> ';
    echo '</tr>';
	echo '<tr> ';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;"><b> Specialiasation:</b></td>';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;">'. $row['doctor_spe'] .'</td> ';
    echo '</tr>';
	echo '<tr> ';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;"><b> Doctor-phone:</b></td>';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;">'. $row['doctor_phone'] .'</td> ';
    echo '</tr>';
	echo '<tr> ';
	echo '<tr> ';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;"><b> Email-ID:</b></td>';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;">'. $row['doctor_email'] .'</td> ';
    echo '</tr>';
	echo '<tr> ';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;"><b> Degree:</b></td>';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;">'. $row['doctor_degree'] .'</td> ';
    echo '</tr>';
	echo '<tr> ';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;"><b> Clinic Name:</b></td>';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;">'. $row['doctor_clinicname'] .'</td> ';
    echo '</tr>';
	echo '<tr> ';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;"><b> Clinic Address:</b></td>';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;">'. $row['doctor_clinicad'] .'</td> ';
    echo '</tr>';
	echo '<tr> ';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;"><b> City:</b></td>';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;">'. $row['doctor_cliniccity'] .'</td> ';
    echo '</tr>';
