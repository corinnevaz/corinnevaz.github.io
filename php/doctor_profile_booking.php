...
echo'<div class="cart_name"> <b>Name:</b> '.$row['customer_name'].'<br><b>Time: </b>'.$row['a_time'].'<br><b>Mobile Number: </b>'.$row['customer_mobile'].'<br></div>';
echo'<div class="cart_del"><b>Status: </b><br>'.$row['Status'].'</div>';
