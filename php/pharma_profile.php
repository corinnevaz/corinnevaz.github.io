...
<div id="sidebar">
  ...
  <h2>PHARMACY PROFILE</h2>
    ...
    <div class="infront">
    	<h3><a href="pharma_profile.php">PROFILE </a></h3>
		        <h3><a href="pharma_profile_order.php">ORDER HISTORY</a></h3>

		<h3><a href="pharma_profile_order_confri.php">ORDER CONFIRMATION </a></h3>
...
$sql = "SELECT * FROM ver_pharmacy WHERE pharmacy_id =".$_SESSION['pharma_id'];
...
if ($result->num_rows > 0) {
  ...
  echo '<table>'; 
    echo '<tr> ';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px"><b> Pharmacy-id:</b></td>';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px">'. $row['pharmacy_id'] .'</td> ';
    echo '</tr>';
	echo '<tr> ';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px"><b> Pharmacy Name:</b></td>';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px">'. $row['pharmacy_name'] .'</td> ';
    echo '</tr>';
		echo '<tr> ';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;"><b>Pharmacy Email:</b></td>';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;">'. $row['pharmacy_email'] .'</td> ';
    echo '</tr>';
	echo '<tr> ';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;"><b> Phone:</b></td>';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;">'. $row['p_contact'] .'</td> ';
    echo '</tr>';
	echo '<tr> ';
	echo '<tr> ';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;"><b> Pharmacy store registration Number:</b></td>';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;">'. $row['p_store_reg_no'] .'</td> ';
    echo '</tr>';
	echo '<tr> ';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;"><b> Pharmacist License Number:</b></td>';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;">'. $row['p_lic_no'] .'</td> ';
    echo '</tr>';
	echo '<tr> ';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;"><b> Address:</b></td>';
      echo '<td style="font-family:Verdana,sans-serif;font-size:16px;">'. $row['p_address'] .'</td> ';
    echo '</tr>';
