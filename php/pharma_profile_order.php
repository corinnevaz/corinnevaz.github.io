...
echo'<div class="cart_name"><br><b>Bill Id:</b>'.$row['bill_id'].'<br><b>Pharmacy Id:</b>'.$row['pharmacy_id'].'<br><b>Product Name</b>'.$row['product_name'].'</div>';
echo"<div class='cart_del'> <b>Status:</b><br>".$row['status']."<br> </div>";
